                ...
                <div className='flex flex-col md:flex-row gap-4 items-center justify-center space-y-2' >
                    ...
                    <div className='space-y-2.5'>
                        <motion.h3
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            transition={{ duration: 0.5, delay: 0.25 }}
                            className='text-secoundary px-8'>Today, SquareUp Continues to Thrive as a Leading Digital Product Agency.....</motion.h3>
                        <motion.p
                            variants={{
                                hidden: { opacity: 0, x: 75 },
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            transition={{ duration: 0.5, delay: 0.25 }}
                            className='text-secoundary max-w-[1242px] mx-auto px-8'>Combining the power of design, engineering, and project management to create transformative digital experiences. They invite you to join them on their journey and discover how they can help bring your digital ideas to life.</motion.p>
                    </div>
                </div>
